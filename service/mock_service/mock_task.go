...
func (mr *MockTaskMockRecorder) CountUnfinishedTaskByJobID(ctx, jobID interface{}) *gomock.Call {
...
func (mr *MockTaskMockRecorder) CreateTask(ctx, job, taskAttributes, isExperiment interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) GetAvailableTask(ctx, jobIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) GetAverageResourceUsage(ctx, jobID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) GetTaskByID(ctx, taskID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) GetTaskByJob(ctx, job interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) UpdateTaskAfterDistribution(ctx, successTasks, errorTasks interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) UpdateTaskSuccess(ctx, taskID, nodeID, result, averageCPUUsage, averageMemoryUsage interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) UpdateTaskToBeReadyToBeDistributed(ctx, jobID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) UpdateTaskWaitTimeout(ctx, taskID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskMockRecorder) UpdateTaskWorkOnFailure(ctx, taskID, nodeID, errMessage interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
