...
func ProvideWorkerNodeTransportCertificate(workerCertificateConfig WorkerNodeTransportCertificate, controlPlaneConfig config.ControlPlaneConfigModel) (TransportCertificate, error) {
...
func registerWorker(workerCertificateConfig WorkerNodeTransportCertificate, controlPlaneConfig config.ControlPlaneConfigModel) (*proto.ComputeNodeRegistrationResponse, KeyData, error) {
