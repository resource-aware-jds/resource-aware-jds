...
type ContainerSendTaskRequest struct {
...
func (x *ContainerSendTaskRequest) Reset() {
	*x = ContainerSendTaskRequest{}
...
func (x *ContainerSendTaskRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ContainerSendTaskRequest) ProtoMessage() {}

func (x *ContainerSendTaskRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_container_proto_msgTypes[0]
...
// Deprecated: Use ContainerSendTaskRequest.ProtoReflect.Descriptor instead.
func (*ContainerSendTaskRequest) Descriptor() ([]byte, []int) {
	return file_proto_container_proto_rawDescGZIP(), []int{0}
}

func (x *ContainerSendTaskRequest) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *ContainerSendTaskRequest) GetTaskAttributes() []byte {
	if x != nil {
...
var file_proto_container_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x18, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x53, 0x65, 0x6e, 0x64,
	...
	0x74, 0x65, 0x73, 0x32, 0x60, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	0x54, 0x61, 0x73, 0x6b, 0x52, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x12, 0x49, 0x0a, 0x08, 0x53, 0x65,
	0x6e, 0x64, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x23, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x53, 0x65, 0x6e, 0x64,
...
var file_proto_container_proto_goTypes = []interface{}{
	(*ContainerSendTaskRequest)(nil), // 0: Container.ContainerSendTaskRequest
	(*emptypb.Empty)(nil),            // 1: google.protobuf.Empty
}
var file_proto_container_proto_depIdxs = []int32{
	0, // 0: Container.ContainerTaskRunner.SendTask:input_type -> Container.ContainerSendTaskRequest
...
func file_proto_container_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_container_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ContainerSendTaskRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
