...
const (
	WorkerNodeContainerReceiver_SubmitSuccessTask_FullMethodName = "/WorkerNode.WorkerNodeContainerReceiver/SubmitSuccessTask"
	WorkerNodeContainerReceiver_ReportTaskFailure_FullMethodName = "/WorkerNode.WorkerNodeContainerReceiver/ReportTaskFailure"
	WorkerNodeContainerReceiver_GetTaskFromQueue_FullMethodName  = "/WorkerNode.WorkerNodeContainerReceiver/GetTaskFromQueue"
)
...
func (c *workerNodeContainerReceiverClient) SubmitSuccessTask(ctx context.Context, in *SubmitSuccessTaskRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, WorkerNodeContainerReceiver_SubmitSuccessTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workerNodeContainerReceiverClient) ReportTaskFailure(ctx context.Context, in *ReportTaskFailureRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, WorkerNodeContainerReceiver_ReportTaskFailure_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workerNodeContainerReceiverClient) GetTaskFromQueue(ctx context.Context, in *GetTaskPayload, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
	err := c.cc.Invoke(ctx, WorkerNodeContainerReceiver_GetTaskFromQueue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WorkerNodeContainerReceiver_SubmitSuccessTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkerNodeContainerReceiver_SubmitSuccessTask_FullMethodName,
	}
...
func _WorkerNodeContainerReceiver_ReportTaskFailure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkerNodeContainerReceiver_ReportTaskFailure_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkerNodeContainerReceiver_GetTaskFromQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkerNodeContainerReceiver_GetTaskFromQueue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
