...
var file_proto_controlplane_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x8e, 0x01, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4a, 0x6f, 0x62, 0x52,
	...
	0x6e, 0x74, 0x22, 0x8d, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4a, 0x6f, 0x62,
	...
	0x52, 0x4c, 0x32, 0xc6, 0x03, 0x0a, 0x0c, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x50, 0x6c,
	...
	,
...
var file_proto_controlplane_proto_goTypes = []interface{}{
	...
	(*TaskResourceUsage)(nil),               // 1: controlplane.TaskResourceUsage
	(*ReportFailureTaskRequest)(nil),        // 2: controlplane.ReportFailureTaskRequest
	(*WorkerCheckInRequest)(nil),            // 3: controlplane.WorkerCheckInRequest
	(*ComputeNodeRegistrationRequest)(nil),  // 4: controlplane.ComputeNodeRegistrationRequest
	(*ComputeNodeRegistrationResponse)(nil), // 5: controlplane.ComputeNodeRegistrationResponse
	(*ControlPlaneTask)(nil),                // 6: controlplane.ControlPlaneTask
	(*CreateJobRequest)(nil),                // 7: controlplane.CreateJobRequest
	(*CreateJobResponse)(nil),               // 8: controlplane.CreateJobResponse
	(*emptypb.Empty)(nil),                   // 9: google.protobuf.Empty
}
var file_proto_controlplane_proto_depIdxs = []int32{
	1, // 0: controlplane.ReportSuccessTaskRequest.taskResourceUsage:type_name -> controlplane.TaskResourceUsage
	6, // 1: controlplane.CreateJobResponse.Tasks:type_name -> controlplane.ControlPlaneTask
	4, // 2: controlplane.ControlPlane.WorkerRegistration:input_type -> controlplane.ComputeNodeRegistrationRequest
	7, // 3: controlplane.ControlPlane.CreateJob:input_type -> controlplane.CreateJobRequest
	3, // 4: controlplane.ControlPlane.WorkerCheckIn:input_type -> controlplane.WorkerCheckInRequest
	2, // 5: controlplane.ControlPlane.ReportFailureTask:input_type -> controlplane.ReportFailureTaskRequest
	0, // 6: controlplane.ControlPlane.ReportSuccessTask:input_type -> controlplane.ReportSuccessTaskRequest
	5, // 7: controlplane.ControlPlane.WorkerRegistration:output_type -> controlplane.ComputeNodeRegistrationResponse
	8, // 8: controlplane.ControlPlane.CreateJob:output_type -> controlplane.CreateJobResponse
	9, // 9: controlplane.ControlPlane.WorkerCheckIn:output_type -> google.protobuf.Empty
	9, // 10: controlplane.ControlPlane.ReportFailureTask:output_type -> google.protobuf.Empty
	9, // 11: controlplane.ControlPlane.ReportSuccessTask:output_type -> google.protobuf.Empty
