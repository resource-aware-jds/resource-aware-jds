...
func InitializeApplication() (ControlPlaneApp, func(), error) {
	...
	job := service.ProvideJobService(iJob, iTask)
	grpcHandler := grpc2.ProvideControlPlaneGRPCHandler(rajdsGrpcServer, iControlPlane, job)
	...
	jobHandler := http2.ProvideJobHandler()
